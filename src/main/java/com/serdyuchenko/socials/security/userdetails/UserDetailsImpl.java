...
/**
 * Адаптер между сущностью Person и контрактом Spring Security UserDetails.
 */
public class UserDetailsImpl implements UserDetails {
    ...
    /**
     * Преобразует роли пользователя в GrantedAuthority, понятные Spring Security.
     *
     * @param person пользователь security-модуля
